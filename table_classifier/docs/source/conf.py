...
# table_classifier documentation build
...
from table_classifier import __version__ as release

# -- Project information -----------------------------------------------------

project = "table_classifier"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "table_classifierdoc"
...
latex_documents = [
    (
        master_doc,
        "table_classifier.tex",
        "table_classifier Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "table_classifier",
        "Project table_classifier codebase.",
        "Data-Science",
    )
]
